...
class BookModel(models.Model):
    ...
    ImportantBook = models.BooleanField(blank=True, null=True)
    GradeLevel = models.CharField(verbose_name="Grade Level of this book (Default is 6-8)", max_length=20, choices=GRADE_CHOICES, default="6-8", null=False, blank=False)
    Rating = models.PositiveIntegerField(validators=[MinValueValidator(1), MaxValueValidator(10)], null=False, blank=False, verbose_name="Rating out of 10")
