...
class BookResponse(models.Model):
    ...
    Description = models.TextField(blank=True, null=True, verbose_name="Description of the book (Optional)")
    Summary = models.TextField(blank=True, null=True, verbose_name="Summary of the book (Optional)")
